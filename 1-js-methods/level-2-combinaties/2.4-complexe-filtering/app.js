...
const middelsteGetallen = getallen.filter(checkGetallen);

function checkGetallen(getal){
...
const langeAwoorden = woorden.filter(checkLangeWoorden)

function checkLangeWoorden(langWoord){
    return langWoord[0] === "a" && langWoord.length > 5;

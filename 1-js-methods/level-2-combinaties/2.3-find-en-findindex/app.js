...
const warmeTemperatuur = temperaturen.find(temperaturen => temperaturen > 25)
...
const koudeTemperatuur = temperaturen.find(temperaturen => temperaturen < 20)
console.log('Eerste koude temperatuur:', koudeTemperatuur);

// TODO: Zoek de index van de eerste temperatuur boven 23 graden
const warmeIndex = temperaturen.findIndex(temperaturen => temperaturen > 23)

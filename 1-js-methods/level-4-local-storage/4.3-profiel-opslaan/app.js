...
function laadProfiel() {
    ...
    const naam = localStorage.getItem('profiel-naam', naam);
    const email = localStorage.getItem('profiel-email', email);
    const leeftijd = localStorage.getItem('profiel-leeftijd', leeftijd);
    const kleur = localStorage.getItem('profiel-kleur', kleur);
